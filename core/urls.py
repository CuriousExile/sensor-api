...
urlpatterns = [
    ...
    path('v1/temperature', TemperatureDataCreateView.as_view(), name='create-temperature-data'),
    path('v1/temperature/current', TemperatureDataView.as_view(), name='temperature-data'),
